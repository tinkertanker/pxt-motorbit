# motor:bit package
[ELECFREKAS Motor:bit](http://www.elecfreaks.com/estore/elecfreaks-motor-bit-for-micro-bit.html) is developed under the cooperation  of [ELECFREAKS](https://www.elecfreaks.com/) and [TINKERCADEMY](https://tinkercademy.com/).
